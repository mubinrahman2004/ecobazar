...
//           <div>
//             <h1 className="text-base font-semibold font-sans">Free Shipping</h1>
//             <p className="text-[14px] font-normal font-sans text-[#999999]">
//               Free shipping on all your order
//             </p>
//           </div>
//         </div>
//         <div className="flex items-center gap-3 ">
//           <MdOutlineHeadsetMic className="text-3xl text-[#00B207]" />
//           <div>
//             <h1 className="text-base font-semibold font-sans">Customer Support 24/7</h1>
//             <p className="text-[14px] font-normal font-sans text-[#999999]">
...
//         </div>
//         <div className="flex items-center gap-3 ">
//           <FaShopify className="text-3xl text-[#00B207]" />
//           <div>
//             <h1 className="text-base font-semibold font-sans">100% Secure Payment</h1>
//             <p className="text-[14px] font-normal font-sans text-[#999999]">
...
//         </div>
//         <div className="flex items-center gap-3 ">
//          <FaBox className="text-3xl text-[#00B207]" />
//           <div>
//             <h1 className="text-base font-semibold font-sans">Money-Back Guarantee</h1>
//             <p className="text-[14px] font-normal font-sans text-[#999999]">
